...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push(`/auth/otp-verify?email=${encodeURIComponent(fields.email)}&context=register`);
    } catch {
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <Link href="/" className="auth-logo">
          ...
          <span className="auth-logo-text">Register</span>
        </Link>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <AuthInput
            ...
            placeholder="Jane Doe" value={fields.name}
            onChange={handleChange} icon={<UserIcon />} error={errors.name}
          ...
          <AuthInput
            ...
            onChange={handleChange} icon={<MailIcon />} error={errors.email}
          ...
          <div>
            <AuthInput
              ...
              onChange={handleChange} icon={<LockIcon />} error={errors.password}
              autoComplete="new-password" required
            />
            {fields.password && (
              <div style={{ marginTop: "-0.6rem", marginBottom: "0.6rem", paddingLeft: "0.05rem" }}>
          ...
          <AuthInput
            ...
            placeholder="Repeat your password" value={fields.confirm}
            onChange={handleChange} icon={<LockIcon />} error={errors.confirm}
            autoComplete="new-password" required
          />
          ...
          {errors.terms && (
            <div className="auth-field-error" style={{ marginTop: "-0.75rem", marginBottom: "0.9rem" }} role="alert">
